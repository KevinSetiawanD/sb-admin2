                            ...
                            <form class="user" method="POST">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6 mb-3 mb-sm-0 mt-3">
                                        <input type="text" class="form-control form-control-user" name="role" id="role"
                                            placeholder="role">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="password" class="form-control form-control-user" nama="password"
                                            id="password" placeholder="password">
                                    </div>
                                </div>
                                <a href="../login/login.php" class="btn btn-primary btn-user btn-block">
                                    Register Account
                                </a>
                                <hr>
